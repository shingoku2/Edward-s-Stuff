...
from src.knowledge_index import KnowledgeIndex, get_knowledge_index
from src.knowledge_store import KnowledgePackStore, get_knowledge_pack_store
from src.session_logger import SessionLogger, get_session_logger
...
class KnowledgeIntegration:
    ...
    def log_conversation(self, game_profile_id: str, question: str, answer: str) -> None:
        ...
        try:
            ...
            self.session_logger.log_event(
                game_profile_id=game_profile_id, event_type="answer", content=answer_summary
            )
