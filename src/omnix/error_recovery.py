...
class ErrorRecovery:
    ...
    @staticmethod
    def with_fallback(
        primary_func: Callable, fallback_func: Callable, logger: Optional[logging.Logger] = None
    ) -> Any:
    ...
    def graceful_degrade(
        feature_name: str, primary_action: Callable, fallback_action: Optional[Callable] = None
    ) -> Any:
...
def error_boundary(
    feature_name: str, fallback_return: Any = None, log_errors: bool = True
) -> Callable:
