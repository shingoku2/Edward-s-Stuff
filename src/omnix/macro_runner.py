...
from omnix.config import DEFAULT_MAX_MACRO_REPEAT
from omnix.macro_manager import Macro, MacroManager, MacroStep, MacroStepType
...
class MacroRunner:
    ...
    def __init__(
        ...
        config=None,
        capabilities: Optional[DesktopCapabilities] = None,
    ):
        """
    ...
    def execute_macro(self, macro: Macro) -> bool:
        ...
        if not self.capabilities.automation_available:
            message = self.capabilities.reason or "Desktop automation is unavailable."
