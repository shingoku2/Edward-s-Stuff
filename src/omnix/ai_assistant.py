...
from omnix.knowledge_integration import (
    KnowledgeIntegration,
    get_knowledge_integration,
)
from omnix.providers import LLMProvider, ProviderError, get_provider
...
Please start a game or tell me which game you'd like help with, and I'll provide specialized assistance for that game."""
    ...
    def clear_history(self):
        ...
        game_name = self.current_game.get("name", "Unknown Game") if self.current_game else None
