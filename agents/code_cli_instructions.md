...
and macOS. Tauri work belongs in the separate
https://github.com/shingoku2/Omnix-Tauri repository. Historical archive plans
may mention frontend, Tauri, or self-hosted CI, but those are not active
